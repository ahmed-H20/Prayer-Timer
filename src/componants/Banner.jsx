const Banner = () => {
  ...
  return (
    <div className="container mx-auto ">
      <div
        dir="ltr"
        className=" mx-auto flex m-h-screen bg-[url('public/bg.png')] text-white flex-col sm:flex-row"
      >
        <div className="w-full sm:w-1/2 shrink-0 px-4 h-auto">
          <img
            className="sm:h-screen my-3 rounded-full mx-auto "
            src="public/28213383_7262024 (copy 1).png"
          />
        </div>
        ...
        <div className=" w-1\2 flex-col text-center text-white flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col justify-center items-center">
            <img className="size-80 hidden sm:block" src="public/22632665_6670940-removebg-preview.png" alt="" />
